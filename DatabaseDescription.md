...
Place.dog  provides dog images. It gives a random image of a dog. I plan to store images of dogs to use. The data is just a standard image link. To hold the image I will have one table with a column for the image link.
